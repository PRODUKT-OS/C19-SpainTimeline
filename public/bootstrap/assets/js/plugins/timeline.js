var TL = function(t) {
    ...
    t.exports = function() {
        ...
        var u, d = x(Array.prototype.forEach), f = x(Array.prototype.pop), p = x(Array.prototype.push), _ = x(String.prototype.toLowerCase), m = x(String.prototype.match), g = x(String.prototype.replace), v = x(String.prototype.indexOf), y = x(String.prototype.trim), w = x(RegExp.prototype.test), b = (u = TypeError,
        function() {
        ...
        var Z = function() {
          ...
          , G = function(t, e) {
            if ("object" !== (void 0 === t ? "undefined" : W(t)) || "function" != typeof t.createPolicy)
                return null;
            var i = null;
        ...
        return function t() {
            ...
            var pt = R
              ...
              , Vt = function(t) {
                Gt && Gt === t || (t && "object" === (void 0 === t ? "undefined" : W(t)) || (t = {}),
                t = T(t),
                ...
                k(kt, I),
                k(kt, z)),
                !0 === Ht.svgFilters && (k(bt, S),
                k(kt, I),
                k(kt, z)),
                !0 === Ht.mathMl && (k(bt, A),
                k(kt, O),
                k(kt, z))),
                t.ADD_TAGS && (bt === xt && (bt = T(bt)),
                k(bt, t.ADD_TAGS)),
                t.ADD_ATTR && (kt === Tt && (kt = T(kt)),
                k(kt, t.ADD_ATTR)),
            ...
            var te = "http://www.w3.org/1998/Math/MathML"
              ...
              , ne = function(t) {
                ...
                if (t.namespaceURI === te)
                    return e.namespaceURI === ie ? "math" === i : e.namespaceURI === ee ? "math" === i && Xt[n] : Boolean(Qt[i]);
                if (t.namespaceURI === ie) {
                    if (e.namespaceURI === ee && !Xt[n])
                        return !1;
                    if (e.namespaceURI === te && !Jt[n])
                        return !1;
              ...
              , oe = function(t) {
                ...
                return t && i && e.body.insertBefore(r.createTextNode(i), e.body.childNodes[0] || null),
              ...
              , ue = function(t) {
                var e = void 0;
                if (ce("beforeSanitizeElements", t, null),
                le(t))
                    return re(t),
                    !0;
                if (m(t.nodeName, /[\u0080-\uFFFF]/))
                ...
                !he(t.firstElementChild) && (!he(t.content) || !he(t.content.firstElementChild)) && w(/<[/\w]/g, t.innerHTML) && w(/<[/\w]/g, t.textContent))
                    return re(t),
                    !0;
                if (!bt[n] || Mt[n]) {
                    if (qt && !$t[n]) {
                ...
                return t instanceof h && !ne(t) ? (re(t),
                !0) : "noscript" !== n && "noembed" !== n || !w(/<\/no(script|embed)/i, t.innerHTML) ? (At && 3 === t.nodeType && (e = t.textContent,
                e = g(e, pt, " "),
                e = g(e, _t, " "),
                t.textContent !== e && (p(i.removed, {
                    element: t.cloneNode()
                }),
                t.textContent = e)),
              ...
              , pe = function t(e) {
                ...
                for (ce("beforeSanitizeShadowDOM", e, null); i = n.nextNode(); )
                    ...
                    ue(i) || (i.content instanceof o && t(i.content),
                    fe(i));
            ...
            return i.sanitize = function(t, r) {
                ...
                Ft)
                    ...
                    1 === (s = (a = oe("\x3c!----\x3e")).ownerDocument.importNode(t, !0)).nodeType && "BODY" === s.nodeName || "HTML" === s.nodeName ? a = s : a.appendChild(s);
                else {
                ...
                for (var d = se(Ft ? t : a); h = d.nextNode(); )
                    3 === h.nodeType && h === c || ue(h) || (h.content instanceof o && pe(h.content),
                    fe(h),
                    c = h);
                if (c = null,
                Ft)
 ...
 */
        (function() {
            ...
            var Je = function t(e) {
                var i, n = (e = null == e ? Gt : Je.defaults(Gt.Object(), e, Je.pick(Gt, Pt))).Array, r = e.Date, V = e.Error, dt = e.Function, ft = e.Math, pt = e.Object, _t = e.RegExp, mt = e.String, gt = e.TypeError, vt = n.prototype, yt = dt.prototype, wt = pt.prototype, bt = e["__core-js_shared__"], xt = yt.toString, kt = wt.hasOwnProperty, Tt = 0, Mt = (i = /[^.]+$/.exec(bt && bt.keys && bt.keys.IE_PROTO || "")) ? "Symbol(src)_1." + i : "", Et = wt.toString, Lt = xt.call(pt), St = Gt._, Dt = _t("^" + xt.call(kt).replace(Z, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"), At = Jt ? e.Buffer : void 0, jt = e.Symbol, It = e.Uint8Array, zt = At ? At.allocUnsafe : void 0, $t = $e(pt.getPrototypeOf, pt), Ut = pt.create, Zt = wt.propertyIsEnumerable, Yt = vt.splice, Vt = jt ? jt.isConcatSpreadable : void 0, Xt = jt ? jt.iterator : void 0, Kt = jt ? jt.toStringTag : void 0, ve = function() {
                    try {
                        var t = ta(pt, "defineProperty");
                        return t({}, "", {}),
                        t
                    } catch (t) {}
                }(), Ee = e.clearTimeout !== Gt.clearTimeout && e.clearTimeout, Xe = r && r.now !== Gt.Date.now && r.now, Ke = e.setTimeout !== Gt.setTimeout && e.setTimeout, Qe = ft.ceil, ti = ft.floor, ei = pt.getOwnPropertySymbols, ii = At ? At.isBuffer : void 0, ni = e.isFinite, ri = vt.join, ai = $e(pt.keys, pt), oi = ft.max, si = ft.min, li = r.now, hi = e.parseInt, ci = ft.random, ui = vt.reverse, di = ta(e, "DataView"), fi = ta(e, "Map"), pi = ta(e, "Promise"), _i = ta(e, "Set"), mi = ta(e, "WeakMap"), gi = ta(pt, "create"), vi = mi && new mi, yi = {}, wi = La(di), bi = La(fi), xi = La(pi), ki = La(_i), Ti = La(mi), Mi = jt ? jt.prototype : void 0, Ei = Mi ? Mi.valueOf : void 0, Li = Mi ? Mi.toString : void 0;
                function Si(t) {
                ...
                function Pi(t, e) {
                    var i = Io(t)
                      ...
                      , l = s.length;
                    for (var h in t)
                        !e && !kt.call(t, h) || o && ("length" == h || r && ("offset" == h || "parent" == h) || a && ("buffer" == h || "byteLength" == h || "byteOffset" == h) || sa(h, l)) || s.push(h);
                    return s
                }
                function qi(t) {
                    var e = t.length;
                ...
                function Ji(t, e, i, n, r, a) {
                    var o, s = 1 & e, h = 2 & e, d = 4 & e;
                    if (i && (o = r ? i(t, n, r, a) : i(t)),
                    void 0 !== o)
                        return o;
                    if (!Wo(t))
                        return t;
                    ...
                    if (x) {
                        if (o = function(t) {
                            ...
                            e && "string" == typeof t[0] && kt.call(t, "index") && (i.index = t.index,
                            i.input = t.input);
                            return i
                        }(t),
                        !s)
                ...
                Ii.prototype.delete = function(t) {
                    var e = this.__data__
                      , i = Wi(e, t);
                    return !(i < 0) && (i == e.length - 1 ? e.pop() : Yt.call(e, i, 1),
                    --this.size,
                    !0)
                }
                ,
                ...
                function vn(t, e, i) {
                    for (var r = i ? de : ue, a = t[0].length, o = t.length, s = o, l = n(o), h = 1 / 0, c = []; s--; ) {
                        ...
                        s && e && (u = fe(u, je(e))),
                        h = si(u.length, h),
                        l[s] = !i && (e || a >= 120 && u.length >= 120) ? new zi(s && u) : void 0
                    }
                    u = t[0];
                    var d = -1
                      , f = l[0];
                ...
                function bn(t, e, i, n, r) {
                    return t === e || (null == t || null == e || !Uo(t) && !Uo(e) ? t != t && e != e : function(t, e, i, n, r, a) {
                        ...
                        if (E && !x)
                            return a || (a = new Ri),
                            o || Qo(t) ? Wr(t, e, i, n, r, a) : function(t, e, i, n, r, a, o) {
                                switch (i) {
                                case T:
                        ...
                        function(t, e, i, n, r, a) {
                            ...
                            for (; ++c < l; ) {
                                ...
                                var m = t[u]
                                  , g = e[u];
                                if (n)
                                    var v = o ? n(g, m, u, e, t, a) : n(m, g, u, t, e, a);
                ...
                function kn(t) {
                    return !(!Wo(t) || (e = t,
                    Mt && Mt in e)) && (Ho(t) ? Dt : ot).test(La(t));
                    var e
                }
                function Tn(t) {
                            ...
                            !function(t, e, i, n, r, a, o) {
                                ...
                                if (u) {
                                    var d = Io(l)
                                      ...
                                      , p = !d && !f && Qo(l);
                                    c = l,
                                    d || f || p ? Io(s) ? c = s : Ro(s) ? c = vr(s) : f ? (u = !1,
                                    c = dr(l, !0)) : p ? (u = !1,
                                    c = pr(l, !0)) : c = [] : Yo(l) || No(l) ? (c = s,
                                    No(s) ? c = ss(s) : Wo(s) && !Ho(s) || (c = aa(l))) : u = !1
                                }
                                u && (o.set(l, c),
                                r(c, l, n, a, o),
                                o.delete(l));
                ...
                function Cn(t, e) {
                    var i = t.length;
                    if (i)
                        return sa(e += e < 0 ? i : 0, i) ? t[e] : void 0
                }
                function Nn(t, e, i) {
                ...
                function Vn(t, e, i, n) {
                    ...
                    for (var o = (e = i(e)) != e, s = null === e, l = Ko(e), h = void 0 === e; r < a; ) {
                        ...
                        if (o)
                            ...
                            m = h ? p && (n || d) : s ? p && d && (n || !f) : l ? p && d && !f && (n || !_) : !f && !_ && (n ? u <= e : u < e);
                        m ? r = c + 1 : a = c
                    }
                ...
                function nr(t, e) {
                    var i = t;
                    return i instanceof Ci && (i = i.value()),
                    _e(e, (function(t, e) {
                ...
                function _r(t, e) {
                    if (t !== e) {
                        var i = void 0 !== t
                          ...
                          , l = e == e
                          , h = Ko(e);
                        if (!s && !h && !a && t > e || a && o && l && !s && !h || n && o && l || !i && l || !r)
                            return 1;
                        if (!n && !a && !h && t < e || h && i && r && !n && !a || s && i && r || !o && r || !l)
                            return -1
                    }
                    return 0
                }
                function mr(t, e, i, r) {
                    for (var a = -1, o = t.length, s = i.length, l = -1, h = e.length, c = oi(o - s, 0), u = n(h + c), d = !r; ++l < h; )
                        u[l] = e[l];
                    for (; ++a < s; )
                        (d || a < o) && (u[i[a]] = t[a]);
                    for (; c--; )
                ...
                function gr(t, e, i, r) {
                    for (var a = -1, o = t.length, s = -1, l = i.length, h = -1, c = e.length, u = oi(o - l, 0), d = n(u + c), f = !r; ++a < u; )
                        d[a] = t[a];
                    for (var p = a; ++h < c; )
                        d[p + h] = e[h];
                    for (; ++s < l; )
                ...
                function jr(t, e) {
                    return function(i, n) {
                        ...
                        void 0 !== n) {
                            if (void 0 === r)
                                return n;
                            "string" == typeof i || "string" == typeof n ? (i = Kn(i),
                            n = Kn(n)) : (i = Xn(i),
                            n = Xn(n)),
                            r = t(i, n)
                        }
                ...
                function Ir(t) {
                    return function(e, i, r) {
                        return r && "number" != typeof r && la(e, i, r) && (i = r = void 0),
                        e = ns(e),
                        void 0 === i ? (i = e,
                        e = 0) : i = ns(i),
                        function(t, e, i, r) {
                            for (var a = -1, o = oi(Qe((e - t) / (i || 1)), 0), s = n(o); o--; )
                                s[r ? o : ++a] = t,
                                t += i;
                            return s
                ...
                function Or(t) {
                    return function(e, i) {
                        return "string" == typeof e && "string" == typeof i || (e = os(e),
                        i = os(i)),
                        t(e, i)
                    }
                }
                ...
                function Fr(t, e, i, r, s, l, h, c) {
                    ...
                    e && 1 != e)
                        g = 8 == e || 16 == e ? function(t, e, i) {
                            var r = Er(t);
                            return function a() {
                                for (var o = arguments.length, s = n(o), l = o, h = Jr(a); l--; )
                                    s[l] = arguments[l];
                                var c = o < 3 && s[0] !== h && s[o - 1] !== h ? [] : Be(s, h);
                                if ((o -= c.length) < i)
                                    return zr(t, e, Dr, a.placeholder, void 0, s, c, void 0, void 0, i - o);
                ...
                function Wr(t, e, i, n, r, a) {
                    ...
                    a.set(e, t); ++u < s; ) {
                        var p = t[u]
                          , _ = e[u];
                        if (n)
                            var m = o ? n(_, p, u, e, t, a) : n(p, _, u, t, e, a);
                        if (void 0 !== m) {
                            if (m)
                                continue;
                            d = !1;
                ...
                function ca(t) {
                    var e = Vr(t)
                      , i = Si[e];
                    if ("function" != typeof i || !(e in Ci.prototype))
                        return !1;
                    if (t === i)
                        return !0;
                    var n = Yr(i);
                ...
                function _a(t, e, i) {
                    ...
                    function() {
                        for (var r = arguments, a = -1, o = oi(r.length - e, 0), s = n(o); ++a < o; )
                            s[a] = r[e + a];
                        a = -1;
                        for (var l = n(e + 1); ++a < e; )
                            l[a] = r[a];
                ...
                function Sa(t) {
                    ...
                    return e.__actions__ = vr(t.__actions__),
                ...
                function Na(t, e, i) {
                    ...
                    if (!n)
                        return -1;
                    var r = n - 1;
                    return void 0 !== i && (r = rs(i),
                    r = i < 0 ? oi(n + r, 0) : si(r, n - 1)),
                    we(t, Xr(e, 3), r, !0)
                }
                function Ia(t) {
                ...
                var za = qn((function(t) {
                  ...
                  , Pa = qn((function(t) {
                    var e = qa(t)
                      , i = fe(t, or);
                    return (e = "function" == typeof e ? e : void 0) && i.pop(),
                ...
                var to = qn((function(t) {
                    var e = t.length
                      , i = e > 1 ? t[e - 1] : void 0;
                    return i = "function" == typeof i ? (t.pop(),
                    i) : void 0,
                    Ya(t, i)
                }
                ));
                ...
                var _o = qn((function(t, e) {
                    if (null == t)
                        return [];
                    var i = e.length;
                    return i > 1 && la(t, e[0], e[1]) ? e = [] : i > 2 && la(e[0], e[1], e[2]) && (e = [e[0]]),
                    Nn(t, on(e, 1), [])
                }
                ))
                  , mo = Xe || function() {
                ...
                function go(t, e, i) {
                    return e = i ? void 0 : e,
                    Fr(t, 128, void 0, void 0, void 0, void 0, e = t && null == e ? t.length : e)
                }
                function vo(t, e) {
                    var i;
                ...
                function bo(t, e, i) {
                    var n, r, o, s, l, h, c = 0, u = !1, d = !1, f = !0;
                    if ("function" != typeof t)
                        throw new gt(a);
                    function p(e) {
                        var i = n
                ...
                function To(t, e) {
                    ...
                    var i = function() {
                        ...
                        return i.cache = a.set(r, o) || a,
                        o
                    };
                    return i.cache = new (To.Cache || Oi),
                    i
                }
                function Mo(t) {
                    if ("function" != typeof t)
                ...
                function Hs(t, e, i) {
                    return t = ls(t),
                    void 0 === (e = i ? void 0 : e) ? function(t) {
                        return Rt.test(t)
                    }(t) ? function(t) {
                        return t.match(Ot) || []
                    }(t) : function(t) {
                ...
                function Xs(t, e, i) {
                    var n = bs(e)
                      , r = un(e, n);
                    null != i || Wo(e) && (r.length || !n.length) || (i = e,
                    e = t,
                    t = this,
                    r = un(e, bs(e)));
                ...
                ), 1), fl = Rr("round"), pl = jr((function(t, e) {
                    return t - e
                }
                ), 0);
                ...
                Si.fill = function(t, e, i, n) {
                    var r = null == t ? 0 : t.length;
                    return r ? (i && "number" != typeof i && la(t, e, i) && (i = 0,
                    n = r),
                    function(t, e, i, n) {
                        var r = t.length;
                        for ((i = rs(i)) < 0 && (i = -i > r ? 0 : r + i),
                ...
                Si.sampleSize = function(t, e, i) {
                    return e = (i ? la(t, e, i) : void 0 === e) ? 1 : rs(e),
                    (Io(t) ? Fi : Hn)(t, e)
                }
                ,
                ...
                Si.slice = function(t, e, i) {
                    var n = null == t ? 0 : t.length;
                    return n ? (i && "number" != typeof i && la(t, e, i) ? (e = 0,
                    i = n) : (e = null == e ? 0 : rs(e),
                    i = void 0 === i ? n : rs(i)),
                    Zn(t, e, i)) : []
                }
                ...
                Si.split = function(t, e, i) {
                    return i && "number" != typeof i && la(t, e, i) && (e = i = void 0),
                ...
                Si.throttle = function(t, e, i) {
                    ...
                    if ("function" != typeof t)
                        throw new gt(a);
                    return Wo(i) && (n = "leading"in i ? !!i.leading : n,
                ...
                Si.isEmpty = function(t) {
                    if (null == t)
                        return !0;
                    if (zo(t) && (Io(t) || "string" == typeof t || "function" == typeof t.splice || Po(t) || Qo(t) || No(t)))
                        return !t.length;
                    var e = na(t);
                    if (e == _ || e == y)
                        return !t.size;
                ...
                Si.isNative = function(t) {
                    if (ua(t))
                        throw new V("Unsupported core-js use. Try https://npms.io/search?q=ponyfill.");
                    return kn(t)
                }
                ,
                Si.isNil = function(t) {
                ...
                Si.lastIndexOf = function(t, e, i) {
                    ...
                    if (!n)
                        return -1;
                    var r = n;
                    return void 0 !== i && (r = (r = rs(i)) < 0 ? oi(n + r, 0) : si(r, n - 1)),
                    e == e ? function(t, e, i) {
                        for (var n = i + 1; n--; )
                            if (t[n] === e)
                                return n;
                ...
                Si.random = function(t, e, i) {
                    if (i && "boolean" != typeof i && la(t, e, i) && (e = i = void 0),
                ...
                Si.template = function(t, e, i) {
                    ...
                    t = ls(t),
                    e = us({}, e, n, Hr);
                    var r, a, o = us({}, e.imports, n.imports, Hr), s = bs(o), l = Ce(o, s), h = 0, c = e.interpolate || ct, u = "__p += '", d = _t((e.escape || ct).source + "|" + c.source + "|" + (c === $ ? it : ct).source + "|" + (e.evaluate || ct).source + "|$", "g"), f = "//# sourceURL=" + (kt.call(e, "sourceURL") ? (e.sourceURL + "").replace(/\s/g, " ") : "lodash.templateSources[" + ++qt + "]") + "\n";
                    ...
                    if (p) {
                        if (tt.test(p))
                            throw new V("Invalid `variable` option passed into `_.template`")
                    } else
                        u = "with (obj) {\n" + u + "\n}\n";
                ...
                Si.truncate = function(t, e) {
                    ...
                    Vo(r)) {
                        if (t.slice(s).search(r)) {
                            var h, c = l;
                            for (r.global || (r = _t(r.source, ls(nt.exec(r)) + "g")),
                            r.lastIndex = 0; h = r.exec(c); )
                                var u = h.index;
                ...
                Ci.prototype.slice = function(t, e) {
                    t = rs(t);
                    var i = this;
                    return i.__filtered__ && (t > 0 || e < 0) ? new Ci(i) : (t < 0 ? i = i.takeRight(-t) : t && (i = i.drop(t)),
                    void 0 !== e && (i = (e = rs(e)) < 0 ? i.dropRight(-e) : i.take(e - t)),
                    i)
                }
                ,
                ...
                hn(Ci.prototype, (function(t, e) {
                    ...
                    r && (Si.prototype[e] = function() {
                        ...
                        return f && p ? t.apply(this, o) : (_ = this.thru(c),
                ...
                Ci.prototype.clone = function() {
                    ...
                    return t.__actions__ = vr(this.__actions__),
...
, function(t, e, i) {
    ...
    const r = navigator ? navigator.userAgent.toLowerCase() : "no-user-agent-specified"
      ...
      , l = (Boolean(s && r.match(/MSIE 9/i)),
    s && document && document.addEventListener,
    -1 !== r.indexOf("webkit"))
      , h = (r.indexOf("android"),
    -1 !== r.search("android [23]"))
    ...
    let K = (tt = (Q = "123456789abcdefghijkmnopqrstuvwxyzABCDEFGHJKLMNPQRSTUVWXYZ").length,
    {
        ...
        decode: function(t) {
            ...
            for (var e = 0; t; ) {
                var i = Q.indexOf(t[0]);
                if (i < 0)
                    throw '"decode" can\'t find "' + t[0] + '" in the alphabet: "' + Q + '"';
                var n = t.length - 1;
                e += i * Math.pow(tt, n),
                t = t.substring(1)
            }
    ...
    lt.extend = function(t) {
        ...
        delete t.statics),
        t.includes && (N.apply(null, [n].concat(t.includes)),
        delete t.includes),
    ...
    class ht {
        on(t, e, i) {
            if (!e)
                throw new D("No callback function provided");
    ...
    const ut = function() {
        ...
        : function() {
          ...
          , _ = function() {
            var e, i = t.createElement("a").style, n = ["webkitTransform", "MozTransform", "OTransform", "msTransform", "Transform"];
        ...
        function x(t, e) {
            var i, n = {};
            return (i = t.match(c)) && (n.rotate = j(i[1], e ? e.rotate : null)),
            (i = t.match(u)) && (n.scale = j(i[1], e ? e.scale : null)),
            (i = t.match(d)) && (n.skewx = j(i[1], e ? e.skewx : null),
            n.skewy = j(i[3], e ? e.skewy : null)),
            (i = t.match(f)) && (n.translatex = j(i[1], e ? e.translatex : null),
        ...
        function T(t) {
            ...
            i = r[2],
            n = r[3],
            "#" + (1 << 24 | e << 16 | i << 8 | n).toString(16).slice(1)) : t).replace(/#(\w)(\w)(\w)$/, "#$1$1$2$2$3$3")
        }
        function M(t) {
        ...
        function S(t, e, i, n, a, o) {
            ...
            var s, l = t || 1e3, h = this, c = o - a, u = r(), d = 0, f = 0;
        ...
        function A(t, e, i, n, r, a, o) {
            ...
            return "string" == typeof i[a][r] ? function(t, e, i) {
                ...
                for (n = 0; n < 6; n++)
                    ...
                    s[n] = r.toString(16);
                return "#" + s.join("")
            }(t, i[a][r], n[a][r]) : (o = Math.round(1e3 * ((n[a][r] - i[a][r]) * t + i[a][r])) / 1e3,
            r in p || (o += e[a][r] || "px"),
            o)
        }
        ...
        function C(t, e) {
            var i, n, r, a = t ? a = isFinite(t.length) ? t : [t] : [], o = e.complete, l = e.duration, c = e.easing, u = e.bezier, d = [], f = [], p = [], v = [];
            for (u && (n = e.left,
            r = e.top,
            delete e.right,
            delete e.bottom,
            ...
            i = a.length; i--; ) {
                ...
                for (var L in e) {
                    ...
                    var C, N = g(a[i], L), I = E(e[L]) ? e[L](a[i]) : e[L];
                    "string" != typeof I || !s.test(I) || s.test(N) ? (d[i][L] = "transform" == L ? x(N) : "string" == typeof I && s.test(I) ? T(N).slice(1) : parseFloat(N),
                    f[i][L] = "transform" == L ? x(I, d[i][L]) : "string" == typeof I && "#" == I.charAt(0) ? T(I).slice(1) : j(I, parseFloat(N)),
                    "string" == typeof I && (C = I.match(h)) && (p[i][L] = C[1])) : delete e[L]
                }
            }
            return S.apply(a, [l, function(t, n, r) {
                for (i = a.length; i--; )
                    for (var o in u && (r = D(v[i], t),
                    a[i].style.left = r[0] + "px",
                    a[i].style.top = r[1] + "px"),
                    e)
                        n = A(t, p, d, f, o, i),
                        "transform" == o ? a[i].style[_] = k(n) : "opacity" != o || m ? a[i].style[M(o)] = n : a[i].style.filter = "alpha(opacity=" + 100 * n + ")"
            }
            , o, c])
        }
        return v((function(t) {
    ...
    class ft {
        ...
        _onDragStart(t) {
            b ? t.originalEvent ? (this.data.pagex.start = t.originalEvent.touches[0].screenX,
        ...
        _onDragMove(t) {
            t.preventDefault(),
            this.data.sliding = !0,
            b ? t.originalEvent ? (this.data.pagex.end = t.originalEvent.touches[0].screenX,
    ...
    var pt, _t = {
        ...
        removeListener: function(t, e, i) {
            var n = R(i)
              , r = "_tl_" + e + n
              , a = t[r];
            a && (b && "dblclick" === e && this.removeDoubleTapListener ? this.removeDoubleTapListener(t, n) : "removeEventListener"in t ? "mousewheel" === e ? (t.removeEventListener("DOMMouseScroll", a, !1),
        ...
        var t, e, i, n, r, a = [], o = a.slice, s = a.filter, l = window.document, h = {}, c = {}, u = {
            "column-count": 1,
            columns: 1,
            "font-weight": 1,
            "line-height": 1,
            ...
            "z-index": 1,
            zoom: 1
        }, d = /^\s*<(\w+|!)[^>]*>/, f = /^<(\w+)\s*\/?>(?:<\/\1>|)$/, p = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, _ = /^(?:body|html)$/i, m = /([A-Z])/g, g = ["val", "css", "html", "text", "data", "width", "height", "offset"], v = l.createElement("table"), y = l.createElement("tr"), w = {
            ...
            th: y,
            "*": l.createElement("div")
        }, b = /complete|loaded|interactive/, x = /^[\w-]*$/, k = {}, T = k.toString, M = {}, E = l.createElement("div"), L = {
            tabindex: "tabIndex",
            readonly: "readOnly",
            for: "htmlFor",
            class: "className",
        ...
        function F(e, i, n) {
            for (t in i)
                n && (I(i[t]) || S(i[t])) ? (I(i[t]) && !I(e[t]) && (e[t] = {}),
                S(i[t]) && !S(e[t]) && (e[t] = []),
                F(e[t], i[t], n)) : void 0 !== i[t] && (e[t] = i[t])
        }
        function H(t, i) {
        ...
        M.fragment = function(t, i, n) {
            var r, a, s;
            return f.test(t) && (r = e(l.createElement(RegExp.$1))),
            r || (t.replace && (t = t.replace(p, "<$1></$2>")),
        ...
        ,
        M.qsa = function(t, e) {
            var i, n = "#" == e[0], r = !n && "." == e[0], a = n || r ? e.slice(1) : e, s = x.test(a);
        ...
        e.fn = {
            ...
            closest: function(t, i) {
                var n = this[0]
                  , r = !1;
                for ("object" == typeof t && (r = e(t)); n && !(r ? r.indexOf(n) >= 0 : M.matches(n, t)); )
                ...
                return "string" == typeof e && void 0 === i ? 0 == this.length || 1 !== this[0].nodeType ? void 0 : "value" == e && "INPUT" == this[0].nodeName ? this.val() : !(n = this[0].getAttribute(e)) && e in this[0] ? this[0][e] : n : this.each((function(n) {
                    if (1 === this.nodeType)
                        if (N(e))
                            ...
                            B(this, e, $(this, i, n, this.getAttribute(e)))
                }
                ))
            },
            ...
            prop: function(t, e) {
                return t = L[t] || t,
                void 0 === e ? this[0] && this[0][t] : this.each((function(i) {
            ...
            css: function(i, r) {
                ...
                var l = "";
                if ("string" == D(i))
                    r || 0 === r ? l = z(i) + ":" + P(i, r) : this.each((function() {
            ...
            removeClass: function(t) {
                return this.each((function(e) {
                    if (void 0 === t)
                        return W(this, "");
                    i = W(this),
                    $(this, t, e, i).split(/\s+/g).forEach((function(t) {
                        i = i.replace(R(t), " ")
                    }
                    )),
                    W(this, i.trim())
    ...
    function(t) {
        ...
        function _(e, i, n, r, o, s, l) {
            ...
            i.split(/\s/).forEach((function(i) {
                if ("ready" == i)
                    return t(document).ready(n);
                var a = d(i);
                a.fn = n,
                a.sel = o,
                a.e in h && (n = function(e) {
                    var i = e.relatedTarget;
        ...
        function m(t, e, i, n, r) {
            ...
            (e || "").split(/\s/).forEach((function(e) {
                u(t, e, i, n).forEach((function(e) {
                    delete a[o][e.i],
                    "removeEventListener"in t && t.removeEventListener(p(e.e), e.proxy, f(e, r))
                }
                ))
            }
            ))
        ...
        t.fn.trigger = function(e, i) {
            return (e = r(e) || t.isPlainObject(e) ? t.Event(e) : b(e))._args = i,
            this.each((function() {
    ...
    function(t) {
        var e, i, n = 0, r = window.document, a = /<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi, o = /^(?:text|application)\/javascript/i, s = /^(?:text|application)\/xml/i, l = /^\s*$/;
        function h(e, i, n, a) {
            if (e.global)
                return function(e, i, n) {
                    var r = t.Event(i);
        ...
        function c(t, e) {
            var i = e.context;
            if (!1 === e.beforeSend.call(i, t, e) || !1 === h(e, i, "ajaxBeforeSend", [t, e]))
                return !1;
            h(e, i, "ajaxSend", [t, e])
        }
        function u(t, e, i, n) {
        ...
        t.ajaxJSONP = function(e, i) {
            if (!("type"in e))
                return t.ajax(e);
            var a, o, s = e.jsonpCallback, l = (t.isFunction(s) ? s() : s) || "jsonp" + ++n, h = r.createElement("script"), f = window[l], p = function(e) {
                t(h).triggerHandler("error", e || "abort")
            }, _ = {
                abort: p
            };
            return i && i.promise(_),
        ...
        t.ajax = function(n) {
            ...
            function(e) {
                ...
                !e.data || e.type && "GET" != e.type.toUpperCase() || (e.url = _(e.url, e.data),
                e.data = void 0)
            }(r),
            ...
            var f = r.dataType
              , m = /\?.+=\?/.test(r.url);
            if ("jsonp" == f || m)
                return m || (r.url = _(r.url, r.jsonp ? r.jsonp + "=?" : !1 === r.jsonp ? "" : "callback=?")),
                t.ajaxJSONP(r, a);
            var g, v = r.accepts[f], y = {}, w = function(t, e) {
                y[t.toLowerCase()] = [t, e]
            }, b = /^([\w-]+:)\/\//.test(r.url) ? RegExp.$1 : window.location.protocol, x = r.xhr(), k = x.setRequestHeader;
            if (a && a.promise(x),
            r.crossDomain || w("X-Requested-With", "XMLHttpRequest"),
            w("Accept", v || "*/*"),
            (v = r.mimeType || v) && (v.indexOf(",") > -1 && (v = v.split(",", 2)[0]),
            ...
            x.onreadystatechange = function() {
                if (4 == x.readyState) {
                    ...
                    if (x.status >= 200 && x.status < 300 || 304 == x.status || 0 == x.status && "file:" == b) {
                        ...
                        try {
                            "script" == f ? (0,
                            eval)(e) : "xml" == f ? e = x.responseXML : "json" == f && (e = l.test(e) ? null : t.parseJSON(e))
                        } catch (t) {
                            i = t
                        }
                        i ? d(i, "parsererror", x, r, a) : u(e, x, r, a)
                    } else
                        d(x.statusText || null, x.status ? "error" : "abort", x, r, a)
                }
            }
            ,
            !1 === c(x, r))
            ...
            for (i in x.open(r.type, r.url, T, r.username, r.password),
            y)
                k.apply(x, y[i]);
        ...
        t.fn.load = function(e, i, n) {
            if (!this.length)
                return this;
            var r, o = this, s = e.split(/\s/), l = m(e, i, n), h = l.success;
        ...
        t.param = function(e, i) {
            ...
            ,
            function e(i, n, r, a) {
                var o, s = t.isArray(n), l = t.isPlainObject(n);
    ...
    const Tt = {
      ...
      , Mt = lt.extend({
        ...
        getDisplayDate: function(t, e) {
            ...
            t || (t = jt.fallback),
            t.constructor != jt && (O("First argument to getDisplayDate must be type Language"),
            t = jt.fallback);
        ...
        findBestFormat: function(t) {
            for (var e = bt, i = 0; i < e.length; i++)
                if (this.data[e[i]])
                    return t ? t in Tt || (t = "short") : t = "base",
                    Tt[t][e[i]];
            return ""
        },
    ...
    class jt {
        ...
        mergeData(t) {
            for (k in It.en)
                t[k] && ("object" == typeof this[k] ? C(t[k], this[k]) : this[k] = t[k])
        }
        formatBigYear(t, e) {
            var i = t.year
            ...
            return O("Language file dateformats missing cosmological. Falling back."),
            Nt(i, e)
        }
        _(t) {
        ...
        formatDate(t, e) {
            return t.constructor == Date ? this.formatJSDate(t, e) : t.constructor == Lt ? this.formatBigYear(t, e) : t.data && t.data.date_obj ? this.formatDate(t.data.date_obj, e) : (O("Unfamiliar date presented for formatting"),
            t.toString())
        }
        formatJSDate(t, e) {
            var i = this
    ...
    function qt(t) {
        ...
        n && (i = F(n[0]),
        t = F(t.substring(0, t.lastIndexOf(i))));
        var r = []
          , a = t.match(/^\s*(\d{1,2})(\d{2})\s*$/);
        if (a ? r = a.slice(1) : 1 == (r = t.split(":")).length && (r = t.split(".")),
        r.length > 4)
        ...
        if (r.length > 2) {
            ...
            if (e.second = parseInt(r[0]),
            isNaN(e.second))
                throw new D("invalid_second_err",r[0]);
            if (2 == r.length) {
                var l = parseInt(r[1]);
                if (isNaN(l))
                    throw new D("invalid_fractional_err",r[1]);
                e.millisecond = 100 * l
            }
        }
        return e
    ...
    class Vt {
        ...
        addEvent(t, e) {
            ...
            return void 0 === t.start_date ? (O("Missing start date, skipping event"),
            console.log(t),
        ...
        _assignID(t) {
            var e = t.unique_id;
            return F(e) || (e = t.text ? $(t.text.headline) : null),
        ...
        _makeUniqueIdentifiers(t, e) {
            for (var i = [t], n = 0; n < e.length; n++)
                F(e[n].unique_id) && (e[n].unique_id = $(e[n].unique_id),
        ...
        _processDates(t) {
            ...
            if (!(t.start_date instanceof e)) {
                ...
                void 0 !== t.end_date && !(t.end_date instanceof e)) {
                    ...
                    for (let t in i)
                        r = r && i[t] == n[t];
                    r ? (O("End date same as start date is redundant; dropping end date"),
                    delete t.end_date) : t.end_date = new e(n)
                }
            }
        }
        getEarliestDate() {
    ...
    function Kt(t, e) {
        ...
        var n, r, a = "", o = !1, s = !1, l = "", h = [], c = [];
        for (r = function(t) {
            return !0 !== s && ("" === t ? t = null : !0 === i.skipinitialspace && (t = t.trim())),
            t
        }
        ,
        n = 0; n < t.length; n += 1)
            a = t.charAt(n),
            !1 !== o || a !== i.delimiter && a !== i.lineterminator ? a !== i.quotechar ? l += a : o ? t.charAt(n + 1) === i.quotechar ? (l += i.quotechar,
            n += 1) : o = !1 : (o = !0,
            s = !0) : (l = r(l),
            h.push(l),
            a === i.lineterminator && (c.push(h),
            h = []),
            l = "",
            s = !1);
        return l = r(l),
    ...
    async function ie(t, e) {
        let i = null
          , n = {};
        if ("function" == typeof e ? i = e : "object" == typeof e && (n = e,
        i = e.callback,
        ...
        if (te(t)) {
            try {
                ...
                return r = new Vt,
                "NetworkError" == t.name ? r.logError(new D("network_err")) : "TLError" == t.name ? r.logError(t) : r.logError(new D("unknown_read_err",t.name)),
                void i(r)
            }
            if (r = new Vt(a),
            a.errors)
    ...
    class ne {
        constructor(t) {
            if (!t)
                throw new D("axis_helper_no_options_err");
            this.scale = t.scale,
            this.minor = t.minor,
            this.major = t.major
        }
        ...
        constructor(t, e) {
            ...
            this._axis_helper = function(t, e) {
                ...
                var i = t.getScale()
                  , n = re[i];
                if (!n)
                    throw new D("axis_helper_scale_err",i);
    ...
    class le {
        ...
        _initLayout() {
            this._el.message = T("div", "tl-timegroup-message", this._el.container),
    ...
    class ce {
        ...
        _createTickElements(t, e, i, n) {
            e.innerHTML = "";
            var r = {};
            if (r[new Date(-1,13,-30).getTime()] = !0,
            n)
        ...
        _positionTickArray(t, e, i) {
            if (t[1] && t[0]) {
                ...
                for (var r = 1, a = 0; a < t.length; a++) {
                    ...
                    o.tick.className = "tl-timeaxis-tick") : (r++,
    ...
    class ue {
        ...
        _initLayout() {
            if (this._el.content_container = T("div", "tl-text-content-container", this._el.container),
    ...
    class de {
        constructor(t, e, i) {
            ...
            C(this.options, e),
            C(this.data, t),
            this.options.background || (this._el.container = T("div", "tl-media"),
        ...
        updateMediaDisplay(t) {
            this._state.loaded && !this.options.background && (this._el.content_item.style.maxHeight = c ? this.options.height / 2 + "px" : this.options.height - this.options.credit_height - this.options.caption_height - 30 + "px",
            this._el.container.style.maxWidth = this.options.width + "px",
            p && (this._el.content_item.offsetWidth,
        ...
        _updateMediaDisplay(t) {
            p && (this._el.content_item.style.maxWidth = this.options.width + "px",
        ...
        showMeta(t, e) {
            ...
            this.data.credit && "" != this.data.credit && (this._el.credit = T("div", "tl-credit", this._el.content_container),
            this._el.credit.innerHTML = 1 == this.options.autolink ? Y(this.data.credit) : this.data.credit,
            this.options.credit_height = this._el.credit.offsetHeight),
            this.data.caption && "" != this.data.caption && (this._el.caption = T("div", "tl-caption", this._el.content_container),
        ...
        updateMeta() {
            !this.data.credit && this.data.credit_alternate && (this._el.credit = T("div", "tl-credit", this._el.content_container),
            this._el.credit.innerHTML = this.data.credit_alternate,
            this.options.credit_height = this._el.credit.offsetHeight),
            !this.data.caption && this.data.caption_alternate && (this._el.caption = T("div", "tl-caption", this._el.content_container),
        ...
        _initLayout() {
            ...
            this.data.link && "" != this.data.link ? (this._el.link = T("a", "tl-media-link", this._el.content_container),
            ...
            this._el.content = T("div", "tl-media-content", this._el.link)) : this._el.content = T("div", "tl-media-content", this._el.content_container)
        }
        _updateDisplay(t, e, i) {
            t && (this.options.width = t),
            e && (this.options.height = e),
    ...
    class fe extends de {
        ...
        createMedia() {
            ...
            this.data.link ? (this._el.content_link = this.domCreate("a", "", this._el.content),
            this._el.content_link.href = this.data.link,
            this._el.content_link.target = "_blank",
            this._el.content_link.setAttribute("rel", "noopener"),
            this._el.content_item = this.domCreate("img", e, this._el.content_link)) : this._el.content_item = this.domCreate("img", e, this._el.content),
    ...
    let me = new class {
        ...
        finish(t) {
            ...
            (i = n.urls).shift(),
            this.pollCount = 0,
            i.length || (e && e.call(n.context, n.obj),
            this.pending[t] = null,
        ...
        load(t, e, i, n, r) {
            ...
            if (!this.pending[t] && (l = this.pending[t] = this.queue[t].shift())) {
                for (a = 0,
                o = (h = l.urls).length; a < o; ++a)
                    c = h[a],
                    d ? s = this.env.gecko ? this.createNode("style") : this.createNode("link", {
                        href: c,
                        rel: "stylesheet"
                    ...
                    this.env.ie && !d ? s.onreadystatechange = function() {
                        /loaded|complete/.test(s.readyState) && (s.onreadystatechange = null,
                        u())
                    }
                    : d && (this.env.gecko || this.env.webkit) ? this.env.webkit ? (l.urls[a] = s.href,
                    this.pollWebKit()) : (s.innerHTML = '@import "' + c + '";',
                    this.pollGecko(s)) : s.onload = s.onerror = u,
                    f.push(s);
                for (a = 0,
                o = f.length; a < o; ++a)
    ...
    class ge extends de {
        _loadMedia() {
            ...
            this.media_id = {},
            this.data.url.match("v=") ? this.media_id.id = t.v : this.data.url.match("/embed/") ? this.media_id.id = this.data.url.split("embed/")[1].split(/[?&]/)[0] : this.data.url.match(/v\/|v=|youtu\.be\//) ? this.media_id.id = this.data.url.split(/v\/|v=|youtu\.be\//)[1].split(/[?&]/)[0] : O("YOUTUBE IN URL BUT NOT A VALID VIDEO"),
        ...
        makeGoogleMapsEmbedURL(t, e) {
            ...
            return function(t) {
                ...
                function(t, a) {
                    ...
                    return (o = r(l, o)).key = e,
                    1 == i && (t = "streetview"),
                    s + "/embed/v1/" + t + function(t) {
                        var e = [];
                        for (var i in t)
    ...
    class we extends de {
        _loadMedia() {
            ...
            vt({
                ...
                error: function(t, i) {
                    var n = "";
                    n += e._("wikipedia_load_err") + "<br/>" + e.media_id + "<br/>" + i,
    ...
    class Me extends de {
        ...
        createMedia(t) {
            ...
            (a = a.replace(/<a href/gi, '<a target="_blank" rel="noopener" href')).includes("pic.twitter.com") ? (pe("https://platform.twitter.com/widgets.js", (function() {
    ...
    class Ee extends de {
        _loadMedia() {
            ...
            t = "https://api.twitter.com/1/statuses/oembed.json?id=" + this.media_id + "&omit_script=true&include_entities=true&callback=?",
            window.twttr = (i = document,
            n = "script",
            r = "twitter-wjs",
            o = i.getElementsByTagName(n)[0],
            s = window.twttr || {},
            i.getElementById(r) || ((a = i.createElement(n)).id = r,
    ...
    class Le extends de {
        ...
        establishMediaID() {
            if (this.data.url.match(/flic.kr\/.+/i)) {
                ...
                if (-1 == e)
                    throw new D("flickr_invalidurl_err");
    ...
    class Ie extends de {
        _loadMedia() {
            var t;
            if (this._el.content_item = this.domCreate("div", "tl-media-item tl-media-iframe", this._el.content),
    ...
    class Oe extends de {
        ...
        _updateMediaDisplay(t) {
            ...
            e > this.options.width ? (O("height is greater"),
            i = this.options.width + 80 + "px",
            n = this.options.width + "px") : (O("width is greater"),
            O(this.options.width),
            i = e + "px",
            n = e - 80 + "px"),
    ...
    class Pe extends de {
        _loadMedia() {
            ...
            this._el.content_item = this.domCreate("div", "tl-media-item tl-media-iframe", this._el.content);
            var e = "";
            e = s || _ || t.match(/dl.dropboxusercontent.com/) ? "<iframe class='doc' frameborder='0' width='100%' height='100%' src='//docs.google.com/viewer?url=" + t + "&amp;embedded=true'></iframe>" : "<iframe class='doc' frameborder='0' width='100%' height='100%' src='" + t + "'></iframe>",
    ...
    class qe extends de {
        ...
        createMedia() {
            ...
            this._el.content_link.target = "_blank",
            this._el.content_link.setAttribute("rel", "noopener"),
            this._el.content_item = this.domCreate("audio", e, this._el.content_link)) : this._el.content_item = this.domCreate("audio", e, this._el.content),
    ...
    class Fe extends de {
        ...
        createMedia() {
            ...
            this._el.content_link.target = "_blank",
            this._el.content_link.setAttribute("rel", "noopener"),
            this._el.content_item = this.domCreate("video", e, this._el.content_link)) : this._el.content_item = this.domCreate("video", e, this._el.content),
            this._el.content_item.controls = !0,
            this._el.source_item = this.domCreate("source", "", this._el.content_item),
            this._el.content_item.addEventListener("load", (function(e) {
                t.onMediaLoaded()
    ...
    class Be {
        ...
        _initLayout() {
            if (this._el.container = T("div", "tl-timemarker"),
    ...
    class We {
        ...
        _momentum() {
            ...
            i.x && (Math.abs(e.x) > this._el.drag.offsetWidth / 2 && (n = !0),
            Math.abs(e.x) > 1e4 && (this.data.direction = "left",
            e.x > 0 && (this.data.direction = "right"))),
            i.y && (Math.abs(e.y) > this._el.drag.offsetHeight / 2 && (n = !0),
            Math.abs(e.y) > 1e4 && (this.data.direction = "up",
            e.y > 0 && (this.data.direction = "down"))),
            e.time < 1e3 || this._animateMomentum(),
            n && this.data.direction ? this.fire("swipe_" + this.data.direction, this.data) : this.data.direction ? this.fire("swipe_nodirection", this.data) : this.options.snap && (this.animator.stop(),
    ...
    class Ue {
        ...
        updateDisplay(t, e, i) {
            let n = !1;
            t && (0 == this.options.width && t > 0 && (n = !0),
        ...
        _getTimeScale() {
            ...
            try {
                ...
                O("Invalid value for marker_height_min option."),
                t = 30
            }
            return 0 == t && (O("marker_height_min option must not be zero."),
            t = 30),
        ...
        _findMarkerIndex(t) {
            var e = -1;
            return ("string" == typeof t || t instanceof String) && (e = U(t, this._markers, "unique_id", e)),
            e
        }
        _createEras(t) {
            for (var e = 0; e < t.length; e++) {
        ...
        goTo(t, e, i) {
            ...
            this._el.slider.style.left = -this._markers[a].getLeft() + this.options.width / 2 + "px") : i ? (this._el.slider.className = "tl-timenav-slider tl-timenav-slider-animate",
            this.animate_css = !0,
            this._el.slider.style.left = -this._markers[a].getLeft() + this.options.width / 2 + "px") : (this._el.slider.className = "tl-timenav-slider",
    ...
    class Ze {
        ...
        updateDisplay(t, e, i) {
            var n, r = this.options.slide_padding_lr, a = this.options.slide_padding_lr;
            this.options.width = t || this._el.container.offsetWidth,
            n = this.options.width - 2 * this.options.slide_padding_lr,
            c && this.options.width <= this.options.skinny_size ? (r = 0,
            a = 0,
            n = this.options.width) : "landscape" == i || this.options.width <= this.options.skinny_size && (r = 50,
            a = 50,
            ...
            this._el.content.style.height = 90 + "%",
        ...
        getFormattedDate() {
            if (F(this.data.display_date).length > 0)
                return this.data.display_date;
            var t = "";
        ...
        _initLayout() {
            if (this._el.container = T("div", "tl-slide"),
            ...
            this.has.media && (this.data.media.mediatype = $e(this.data.media),
            this.options.media_name = this.data.media.mediatype.name,
            this.options.media_type = this.data.media.mediatype.type,
            this.options.autolink = this.data.autolink,
            this._media = new this.data.media.mediatype.cls(this.data.media,this.options,this.getLanguage())),
            (this.has.text || this.has.headline) && (this._text = new ue(this.data.text,{
                title: this.has.title,
                language: this.options.language,
                autolink: this.data.autolink
            }),
            this._text.addDateText(this.getFormattedDate())),
            this.has.text || this.has.headline || !this.has.media ? this.has.headline && this.has.media && !this.has.text ? (L(this._el.container, "tl-slide-media-only"),
            this._text.addTo(this._el.content),
            this._media.addTo(this._el.content)) : this.has.text && this.has.media ? (this._media.addTo(this._el.content),
            this._text.addTo(this._el.content)) : (this.has.text || this.has.headline) && (L(this._el.container, "tl-slide-text-only"),
            this._text.addTo(this._el.content)) : (L(this._el.container, "tl-slide-media-only"),
    ...
    class Ye {
        constructor(t, e, i, n) {
            ...
            this.options.id = B(6, "tl")) : (this.options.id = t,
            this._el.container = x(t)),
        ...
        _findSlideIndex(t) {
            var e = t;
            return ("string" == typeof t || t instanceof String) && (e = U(t, this._slides, "unique_id")),
            e
        }
        ...
        goTo(t, e, i) {
            ...
            this._onSlideChange(i)) : this.animator = ct(this._el.slider_container, {
        ...
        changeBackground(t) {
            ...
            t.color_value && "" != t.color_value ? (e = j(t.color_value)) || (O("Invalid color value " + t.color_value),
        ...
        _initLayout() {
            ...
            b && (this._swipable = new We(this._el.slider_container_mask,this._el.slider_container,{
                enable: {
                    x: !0,
                    y: !1
                },
            ...
            this._swipable.enable(),
            this._message = new Rt(this._el.container,{
        ...
        _fireMouseEvent(t) {
            if (this._loaded) {
                ...
                this.hasEventListeners(e) && ("contextmenu" === e && _t.preventDefault(t),
                this.fire(e, {
                    latlng: "something",
    ...
    class Xe {
        constructor(t, e, i) {
            ...
            "string" == typeof i.default_bg_color) {
                ...
                n ? i.default_bg_color = n : (delete i.default_bg_color,
            ...
            this._loadStyles(),
            document.addEventListener("keydown", (r = this,
            function(t) {
                if (r.config) {
                    var e = t.key
            ...
            .bind(this)),
            this.options.debug && (a = console.log,
            I.push(a)),
        ...
        _translateError(t) {
            return t.hasOwnProperty("stack") && O(t.stack),
            t.message_key ? this._(t.message_key) + (t.detail ? " [" + t.detail + "]" : "") : t
        }
        showMessage(t) {
            this.message ? this.message.updateMessage(t) : (O("No message display available."),
            O(t))
        }
        determineScriptPath() {
            let t = null;
        ...
        _initLayout() {
            ...
            "top" == this.options.timenav_position ? (this._el.timenav = T("div", "tl-timenav", this._el.container),
            this._el.storyslider = T("div", "tl-storyslider", this._el.container)) : (this._el.storyslider = T("div", "tl-storyslider", this._el.container),
        ...
        _updateDisplay(t, e, i) {
            var n, r = this.options.duration, a = this.options.base_class, o = 0;
            i && (r = i),
            this.options.width = this._el.container.offsetWidth,
            this.options.height = this._el.container.offsetHeight,
            this.options.width <= this.options.skinny_size ? (a += " tl-skinny",
            this.options.layout = "portrait") : this.options.width <= this.options.medium_size ? (a += " tl-medium",
            this.options.layout = "landscape") : this.options.layout = "landscape",
            b && (this.options.layout = (n = "portrait",
            ...
            o = "top" == this.options.timenav_position ? Math.ceil(this.options.timenav_height) / 2 - this._el.menubar.offsetHeight / 2 - 19.5 : Math.round(this.options.storyslider_height + 1 + Math.ceil(this.options.timenav_height) / 2 - this._el.menubar.offsetHeight / 2 - 17.5),
        ...
        _onLoaded() {
            if (this._loaded.storyslider && this._loaded.timenav)
                if (this.fire("loaded", this.config),
